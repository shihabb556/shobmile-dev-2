...
const Products = () => {
 ...
 const handleSearch = ()=>{
  ...
  return (
    <>
      <div className="mt-10 min-h-screen bg-gray-100 pb-10 pt-[1em] md:px-4 relative">
        <FilterSidebar
          isOpen={isFilterOpen}
        ...
        <div className="mt-5 grid px-2 grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-5">
